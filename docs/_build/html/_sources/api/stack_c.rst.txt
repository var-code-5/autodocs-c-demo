...
This function resets the given stack to an empty state by setting its top pointer to zero. This is typically called before using a stack for operations such as pushing or popping elements.
...
This function pushes a double precision floating-point value onto the specified stack. If the stack is already at its capacity, it returns CALC\_ERR\_OVERFLOW. Otherwise, it successfully adds the value to the stack and increments the top index, returning CALC\_OK.
